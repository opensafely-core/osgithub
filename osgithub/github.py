...
class GithubRepo:
    ...
    def get_last_updated(self, path, ref):
        ...
        # GitHub returns UTC timestamps with a trailing Z; normalize it to an
        # explicit UTC offset so strptime can create an aware datetime with %z.
        return datetime.strptime(
            last_commit_date.replace("Z", "+00:00"), "%Y-%m-%dT%H:%M:%S%z"
        )
